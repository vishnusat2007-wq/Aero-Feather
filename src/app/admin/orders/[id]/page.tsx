...
export default async function AdminOrderDetailPage({
  ...
  return (
    <div className="max-w-3xl">
      <h1 className="text-3xl font-bold text-navy">Order details</h1>
      <p className="mt-1 text-slate-600">{order.email}</p>

      <div className="mt-8 grid gap-6 rounded-2xl border border-slate-200 bg-white p-6">
        ...
        <form action={updateOrderStatusAction} className="flex items-end gap-4 border-t pt-4">
